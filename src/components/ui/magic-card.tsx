...
export function MagicCard(props: MagicCardProps) {
  ...
  // next-themes resolves "system" for us and is undefined until mounted,
  // so we default to dark-mode blending until the client theme is known.
  const { resolvedTheme } = useTheme()
  const isDarkTheme = resolvedTheme ? resolvedTheme === "dark" : true
